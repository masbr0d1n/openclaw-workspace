...
"[project]/.openclaw/workspace/streamhub-videotron/src/app/api/v1/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // Forward to backend
        const response = await fetch('http://192.168.8.117:8001/api/v1/auth/login', {
            method: 'POST',
            headers: {
        ...
        if (!response.ok) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f2e$openclaw$2f$workspace$2f$streamhub$2d$videotron$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(error, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__597d092e._.js.map