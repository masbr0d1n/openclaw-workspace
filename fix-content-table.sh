...
# Fix Content Table - Complete Implementation
# This script updates frontend and backend to fix all table issues

echo "=== UPDATING FRONTEND WITH FIXES ==="

# Create updated content page with:
# 1. Proper data display (thumbnail, category, expiry, tags)
# 2. Clickable thumbnail to view video
# 3. Icon buttons (View, Edit, Delete) instead of 3-dot menu
# 4. Working handlers for all actions

cd /home/sysop/.openclaw/workspace/streamhub-nextjs

# Create the updated page
cat > src/app/dashboard/content/page-tmp.tsx << 'FRONTEND_EOF'
'use client';
...
mv src/app/dashboard/content/page-tmp.tsx src/app/dashboard/content/page.tsx

echo "✅ Frontend updated with all fixes"

echo ""
echo "=== SUMMARY OF FIXES ==="
echo "1. ✅ Thumbnail clickable to view video"
echo "2. ✅ Category shown from channel relationship"
echo "3. ✅ Expiry date displayed"
echo "4. ✅ Tags displayed as chips"
echo "5. ✅ Icon buttons: View, Edit, Delete"
echo "6. ✅ Edit dialog with form"
echo "7. ✅ Delete confirmation dialog"
echo ""
echo "Next: Rebuild frontend and test with Puppeteer"
